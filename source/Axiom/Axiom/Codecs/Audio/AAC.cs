...
{
    public class AAC : Controls.IAudioCodec
    {
        // ---------------------------------------------------------------------------
        // Codec
        // ---------------------------------------------------------------------------
        ...
        {
            new ViewModel.Audio.AudioCodec() { Codec = "aac", Parameters = "" }
        };
        ...
        {
            new ViewModel.Audio.AudioQuality() { Name = "Auto",   CBR_BitMode = "-b:a", CBR = "",    VBR_BitMode = "-q:a", VBR = "2", NA = "400" },
            new ViewModel.Audio.AudioQuality() { Name = "400",    CBR_BitMode = "-b:a", CBR = "400", VBR_BitMode = "-q:a", VBR = "2"   },
            new ViewModel.Audio.AudioQuality() { Name = "320",    CBR_BitMode = "-b:a", CBR = "320", VBR_BitMode = "-q:a", VBR = "2"   },
            new ViewModel.Audio.AudioQuality() { Name = "256",    CBR_BitMode = "-b:a", CBR = "256", VBR_BitMode = "-q:a", VBR = "1.6" },
            new ViewModel.Audio.AudioQuality() { Name = "224",    CBR_BitMode = "-b:a", CBR = "224", VBR_BitMode = "-q:a", VBR = "1.4" },
            new ViewModel.Audio.AudioQuality() { Name = "192",    CBR_BitMode = "-b:a", CBR = "192", VBR_BitMode = "-q:a", VBR = "1.2" },
            new ViewModel.Audio.AudioQuality() { Name = "160",    CBR_BitMode = "-b:a", CBR = "160", VBR_BitMode = "-q:a", VBR = "1" },
            new ViewModel.Audio.AudioQuality() { Name = "128",    CBR_BitMode = "-b:a", CBR = "128", VBR_BitMode = "-q:a", VBR = "0.8" },
            new ViewModel.Audio.AudioQuality() { Name = "96",     CBR_BitMode = "-b:a", CBR = "96",  VBR_BitMode = "-q:a", VBR = "0.6" },
            new ViewModel.Audio.AudioQuality() { Name = "64",     CBR_BitMode = "-b:a", CBR = "64",  VBR_BitMode = "-q:a", VBR = "0.4" },
        ...
        public ObservableCollection<ViewModel.Audio.AudioSampleRate> sampleRate { get; set; } = new ObservableCollection<ViewModel.Audio.AudioSampleRate>()
        {
            ...
            new ViewModel.Audio.AudioSampleRate() { Name = "7.35k",    Frequency = "7350" },
