...
using ViewModel;
//using static Axiom.Controls.Audio.Codec;
...
namespace Controls
{
    namespace Audio
    {
        namespace Codec
        {
            public class AC3 //: Controls.Audio.Codec
            {
                // ---------------------------------------------------------------------------
                // Codec
                // ---------------------------------------------------------------------------
                ...
                {
                        new ViewModel.Audio.AudioQuality() { Name = "Auto",   CBR_BitMode = "-b:a", CBR = "",    VBR_BitMode = "", VBR = "", NA = "640" },
