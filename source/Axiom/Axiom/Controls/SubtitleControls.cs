...
namespace Controls
{
    namespace Subtitles
    {
        ...
        {
            private static Dictionary<string, ISubtitleCodec> _sCodecClass;

            private static void InitializeCodecs()
            {
                _sCodecClass = new Dictionary<string, ISubtitleCodec> {
            ...
            public static void CodecControls(string codec_SelectedItem)
            {
                ...
                if (!string.IsNullOrWhiteSpace(codec_SelectedItem))
                {
                    ...
                    {
                        "-c:s",
                        _sCodecClass[codec_SelectedItem].codec.FirstOrDefault()?.Codec,
                        _sCodecClass[codec_SelectedItem].codec.FirstOrDefault()?.Parameters
                    };
                    ...
                    // Items Source
                    // -------------------------
                    VM.SubtitleView.Subtitle_Stream_Items = _sCodecClass[codec_SelectedItem].stream;
